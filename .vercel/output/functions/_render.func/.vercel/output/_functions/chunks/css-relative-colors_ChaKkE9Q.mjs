import { aa as __astro_tag_component__, ab as Fragment, a4 as createVNode } from './astro_I20JpDLc.mjs';
import { $ as $$Image } from './pages/generic_BP2NdYmY.mjs';

const MDXLayout = async function ({
  children
}) {
  const Layout = (await import('./SingleBlogPost_BMZU7vsJ.mjs')).default;
  const {
    layout,
    ...content
  } = frontmatter;
