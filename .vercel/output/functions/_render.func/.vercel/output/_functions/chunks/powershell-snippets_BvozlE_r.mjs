const id = "powershell-snippets.mdx";
						...
						const data = {title:"PowerShell snippets",description:"PowerShell snippets",tags:["powershell"],date_published:null,date_added:new Date(1713353356000),date_updated:new Date(1713353440000),pinned:false};
						const _internal = {
							type: 'content',
