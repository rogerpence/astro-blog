import { c as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, f as createAstro, g as renderComponent, l as renderSlot } from './astro_Bindw8GW.mjs';
import { g as getCollection, f as filterBlogPosts, e as getTagsFromPosts } from './pages/__Dawp_2IE.mjs';

const $$Astro$2 = createAstro();
const $$SmallTagsList = createComponent(async ($$result, $$props, $$slots) => {
...
const $$GlobalTagsList = createComponent(async ($$result, $$props, $$slots) => {
